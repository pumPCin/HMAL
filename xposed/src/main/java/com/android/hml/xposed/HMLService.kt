package com.android.hml.xposed

import android.content.pm.ApplicationInfo
import android.content.pm.IPackageManager
import android.os.Build
import com.android.hml.common.*
import com.android.hml.xposed.hook.*
import java.io.File

class HMLService(val pms: IPackageManager) : IHMLService.Stub() {

    companion object {
        private const val TAG = "Service"
        var instance: HMLService? = null
    }
    ...
    private fun searchDataDir() {
        ...
        File("/data/misc").list()?.forEach {
            if (it.startsWith("com.google.hml.")) {
        ...
        if (!this::dataDir.isInitialized) {
            dataDir = "/data/misc/com.google.hml." + Utils.generateRandomString(8)
        }
