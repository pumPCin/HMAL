...
import com.google.android.hml.databinding.FragmentSettingsBinding
import com.android.hml.common.CommonUtils
import com.android.hml.common.Constants
import com.android.hml.sysApp
import com.android.hml.service.ConfigManager
import com.android.hml.service.PrefManager
...
import com.android.hml.util.LangList
import com.android.hml.util.SuUtils
        ...
        override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
            ...
            findPreference<Preference>("forceCleanEnv")?.setOnPreferenceClickListener {
                MaterialAlertDialogBuilder(requireActivity())
                    ...
                    .setMessage(R.string.settings_is_clean_env_summary)
                    .setPositiveButton(android.R.string.ok) { _, _ ->
                        val result = SuUtils.execPrivileged("rm -rf /data/misc/com.google.hml.*")
